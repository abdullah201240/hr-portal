...
export function EmployeeHeader({ isMobile = false }: { isMobile?: boolean } = {}) {
  const { theme, setTheme } = useTheme();
  const { logout, employeeProfile } = useEmployeeAuth();
    ...
    <header className="sticky top-0 z-50 w-full glass-strong border-b border-emerald-500/10">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 w-full max-w-full">
        {isMobile ? (
          ...
          <>
            ...
            <div className="flex items-center ml-2">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64 sm:w-72 glass-strong p-0 overflow-hidden">
                  {/* Profile Header */}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground truncate">
                          {employeeProfile?.email || 'employee@hrportal.com'}
                        </p>
                  ...
                  <div className="p-1.5">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs opacity-70">Logout from employee panel</p>
                      </div>
                    </DropdownMenuItem>
                  </div>
                </DropdownMenuContent>
          ...
          // Desktop view: Full layout with search, theme toggle, and user menu
          <>
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="ghost" className="relative h-10 rounded-xl glass hover:glass-strong px-3 gap-2">
                      ...
                      <div className="hidden md:flex flex-col items-start">
                        <span className="text-sm font-medium leading-none">{employeeProfile?.name || 'Employee'}</span>
                        <span className="text-xs text-muted-foreground leading-none mt-1">Staff</span>
                      </div>
